...
class TestCutting:
    def test_one(self):
        assert cut("ante tu golpe fiero. Cuerpo a cuerpo, en la noche,") == (["ante tu golpe fiero.", "Cuerpo a cuerpo, en la noche,"])
...
class TestClean:
    def test_one(self):
        assert clean(["ante tu golpe fiero. Cuerpo a cuerpo, en la noche,",
                      """Los vientos del alba son feos. y las mentes de los céfiros, 
                      doblegadas por las bañeras, aumentan sus tormentos. Mañana"""]) == (["ante tu golpe fiero.",
